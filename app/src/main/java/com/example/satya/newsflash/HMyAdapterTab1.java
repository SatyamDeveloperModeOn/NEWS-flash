...
public class HMyAdapterTab1 extends RecyclerView.Adapter<HMyAdapterTab1.MyViewHolder> {
    ArrayList<HFeedItemTab1> feedItemTab1s;
    Context context;
    public HMyAdapterTab1(Context context, ArrayList<HFeedItemTab1> feedItemTab1s){
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        final HFeedItemTab1 current= feedItemTab1s.get(position);

...
public class MyAdapterTab2 extends RecyclerView.Adapter<MyAdapterTab2.MyViewHolder> {
    ArrayList<FeedItemTab2> feedItemTab2s;
    Context context;
    public MyAdapterTab2(Context context, ArrayList<FeedItemTab2> feedItemTab2s){
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        final FeedItemTab2 current= feedItemTab2s.get(position);

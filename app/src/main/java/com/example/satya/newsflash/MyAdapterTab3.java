...
public class MyAdapterTab3 extends RecyclerView.Adapter<MyAdapterTab3.MyViewHolder> {
    ArrayList<FeedItemTab3> feedItemTab3s;
    Context context;
    public MyAdapterTab3(Context context, ArrayList<FeedItemTab3> feedItemTab3s){
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        final FeedItemTab3 current= feedItemTab3s.get(position);
